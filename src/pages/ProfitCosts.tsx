        ...
        <div className="ds2-visual-scope" style={visualStyle} data-ds2-neutral={prefs.neutralFamilyId}>
            <div className="space-y-5 px-4 pb-7 pt-1 md:hidden">
                    ...
                    <>
                        <header className="flex items-start justify-between gap-3 pt-2">
                            ...
                            <div className="flex gap-2">
                                <AdminActionButton type="button" variant="icon" icon={SlidersHorizontal} onClick={() => setShowMobilePeriodPicker(true)} className="min-w-touch-xs" aria-label="Choose reporting period" />
                        ...
                        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                            <ListRow onClick={() => setShowMobilePeriodPicker(true)}>
                                <span className="min-w-0 flex-1"><span className="block text-xs font-semibold uppercase tracking-wide text-gray-500">Reporting period</span><span className="mt-1 block text-base font-semibold text-gray-900">{mobileDateRangeLabel}</span></span>
                ...
                {mobileView === 'operating' && (
                    <>
                        <header className="flex min-h-touch-xs items-center gap-2"><AdminActionButton type="button" variant="icon" icon={ChevronLeft} onClick={() => setMobileView('overview')} className="min-w-touch-xs" aria-label="Back to profit overview" /><div><p className="text-sm font-medium text-gray-500">Manage</p><h1 className="text-2xl font-bold tracking-tight text-gray-950">{t('profitCosts.operatingCosts.title')}</h1></div></header>
                        ...
                        <div className="flex items-center justify-between px-1"><h2 className="text-lg font-bold text-gray-950">Your charges</h2><button type="button" onClick={handleResetOperatingCosts} className="min-h-touch-xs rounded-xl border border-[var(--ds2-danger-border,#fca5a5)] px-2 text-sm font-semibold text-[var(--ds2-danger-solid,#dc2626)] hover:bg-[var(--ds2-danger-tint-bg,#fef2f2)]">{t('profitCosts.operatingCosts.reset')}</button></div>
                ...
                {mobileView === 'products' && (
                    <>
                        <header className="flex min-h-touch-xs items-center gap-2"><AdminActionButton type="button" variant="icon" icon={ChevronLeft} onClick={() => setMobileView('overview')} className="min-w-touch-xs" aria-label="Back to profit overview" /><div><p className="text-sm font-medium text-gray-500">Sales performance</p><h1 className="text-2xl font-bold tracking-tight text-gray-950">Product profitability</h1></div></header>
                        ...
                        <TabToggle options={[{ value: 'profit', label: 'Profit' }, { value: 'margin', label: 'Margin' }, { value: 'cost', label: 'Cost' }]} value={mobileProductMetric} onChange={setMobileProductMetric} />
                ...
                {mobileView === 'inventory' && (
                    <>
                        <header className="flex min-h-touch-xs items-center gap-2"><AdminActionButton type="button" variant="icon" icon={ChevronLeft} onClick={() => setMobileView('overview')} className="min-w-touch-xs" aria-label="Back to profit overview" /><div><p className="text-sm font-medium text-gray-500">Stock value</p><h1 className="text-2xl font-bold tracking-tight text-gray-950">Inventory capital</h1></div></header>
