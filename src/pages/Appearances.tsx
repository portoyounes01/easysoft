...
const previewTabOptions: SegmentOption<PreviewTab>[] = [
    { value: 'order', label: 'Order screen', icon: ShoppingBag },
    { value: 'menu', label: 'Menu screen', icon: ImageIcon },
];

const orderItems = [
    { quantity: 2, name: 'Double Cheeseburger', detail: '$5.49 each', amount: '$10.98' },
    { quantity: 1, name: 'Fries', detail: 'Large', amount: '$2.49' },
    { quantity: 1, name: 'Iced Coffee', detail: 'Medium', amount: '$2.49' },
    { quantity: 1, name: 'Apple Pie', detail: 'Dessert', amount: '$1.99' },
];

const menuItems = [
    { name: 'House Burger', price: '$8.95', badge: 'Popular' },
    { name: 'Chicken Wrap', price: '$7.40', badge: 'Lunch' },
    { name: 'Caesar Salad', price: '$6.80', badge: 'Fresh' },
    { name: 'Cold Brew', price: '$3.20', badge: 'Drink' },
];
    ...
    <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
        <div className="mb-6 flex items-center justify-between">
            <div className="flex items-baseline gap-3">
                <h3 className="text-2xl font-bold text-neutral-900">Order</h3>
                <span className="text-sm font-bold text-green-600">Eat in</span>
            </div>
            <button
                type="button"
        ...
        <div className="space-y-4">
            {orderItems.map((item) => (
                <div key={item.name} className="grid grid-cols-[2rem_1fr_auto] gap-3 text-sm">
...
const MenuPreview: React.FC = () => (
    <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
        <div className="mb-5 flex items-center justify-between">
            <div>
                <h3 className="text-2xl font-bold text-neutral-900">Menu</h3>
                <p className="mt-1 text-sm text-neutral-500">Fast order tiles with image space.</p>
            </div>
            <span className="rounded-full bg-blue-50 px-3 py-1 text-sm font-bold text-blue-700">Lunch</span>
        </div>
...
const AppearancePreview: React.FC<AppearancePreviewProps> = ({ previewTab, onPreviewTabChange }) => (
    <aside className="space-y-5">
        <section className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
            <div className="mb-5 flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm leading-5 text-neutral-500">See how these settings look in the POS.</p>
                </div>
            </div>
        ...
        <div className="flex items-start gap-3 rounded-2xl border border-neutral-200 bg-white p-4 text-sm text-neutral-600 shadow-sm">
            ...
            <div>
                <p className="font-bold text-neutral-900">Saved on this device.</p>
                <p className="mt-1">Other devices can keep their own appearance settings.</p>
            </div>
        </div>
    </aside>
);
            ...
            <div className={`${layoutClasses.contentColumnMaxW} mx-auto`}>
                <header className="mb-7 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div className="flex min-w-0 items-start gap-4">
                        ...
                        <div className="min-w-0">
                            <h1 className="text-3xl font-bold tracking-normal text-neutral-900">Appearances</h1>
                            <p className="mt-2 max-w-2xl text-base leading-6 text-neutral-500">
                                Customize how your POS looks and feels across colors, spacing, corners, and layout.
                            </p>
                        </div>
                    </div>
                    <AdminActionButton
                ...
                <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1.35fr)_minmax(24rem,0.9fr)]">
                    <div className="space-y-5">
                        <SectionCard
                            icon={Sun}
                            title="Canvas"
                            description="Choose the page background behind the sidebar and content."
                        >
                        ...
                        <SectionCard
                            icon={Type}
                            title="Density and corners"
                            description="Tune touch spacing and control shape without changing the underlying workflow."
                        >
                            <div className="space-y-5">
                                <div>
                                    <p className="mb-2 text-sm font-bold text-neutral-700">Content density</p>
                                    <SegmentedControl
                                ...
                                <div>
                                    <p className="mb-2 text-sm font-bold text-neutral-700">Corner radius</p>
                                    <SegmentedControl
                        ...
                        <SectionCard
                            ...
                            title="Layout"
                            description="Set sidebar width, content width, preview surfaces, and the neutral text scale."
                        >
                            <div className="space-y-5">
                                <div>
                                    <p className="mb-2 text-sm font-bold text-neutral-700">Sidebar width</p>
                                    <SegmentedControl
                                ...
                                <div>
                                    <p className="mb-2 text-sm font-bold text-neutral-700">Content width</p>
                                    <SegmentedControl
                                ...
                                <div>
                                    <p className="mb-2 text-sm font-bold text-neutral-700">Card style</p>
                                    <SegmentedControl
                                ...
                                <div>
                                    <p className="mb-2 text-sm font-bold text-neutral-700">Neutral scale</p>
                                    <SegmentedControl
